<section class="w-full py-[50px]">
    <div class="max-w-6xl m-auto py-[80px] px-4">
        <div class="text-center mb-6">
            <h2 class="text-4xl font-bold mb-6">Why Choose <span class="text-blue-600">INVIZIBAL!</span></h2>
        ...
        <div class="grid grid-cols-3 gap-6">
            <div class="bg-white p-8 rounded-lg border border-gray-100 hover:shadow-lg transition-all">
                <div class="bg-blue-600/10 p-3 w-fit mb-3 rounded-md">
                    <img src="https://api.iconify.design/tabler:bulb-filled.svg?color=%232763ef" width="25" alt="Idea Logo">
                </div>
            ...
            <div class="bg-white p-8 rounded-lg border border-gray-100 hover:shadow-lg transition-all">
                <div class="bg-blue-600/10 p-3 w-fit mb-3 rounded-md">
                    <img src="https://api.iconify.design/ic:baseline-settings.svg?color=%232763ef" width="25" alt="Idea Logo">
                </div>
            ...
            <div class="bg-white p-8 rounded-lg border border-gray-100 hover:shadow-lg transition-all">
                <div class="bg-blue-600/10 p-3 w-fit mb-3 rounded-md">
                    <img src="https://api.iconify.design/solar:shield-star-bold.svg?color=%232763ef" width="25" alt="Idea Logo">
                </div>
