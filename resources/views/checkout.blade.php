...
@section('content')
    <header class="min-h-[600px] bg-cover bg-center relative flex items-center justify-center" style="background-image: url('{{ asset('assets/images/checkout.jpg') }}')">
    ...
    <section class="w-full">
        <div class="max-w-6xl m-auto py-12 px-4">
            <div class="bg-white rounded-xl grid grid-cols-5 gap-6 p-6">
                ...
                <div class="col-span-2 p-6 bg-gray-100 rounded-xl relative h-fit">
